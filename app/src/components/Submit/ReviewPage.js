    ...
    <div>
      ...
      <div className="Submit__body">
        ...
        <h4 className="Submit__review-subtitle">
          You opted to increase overall service spending from last years amount.
        </h4>
        {services.map(service => {
          const incDecText =
            service.percentChange > 0 ? 'Increased' : 'Decreased';
        ...
        <Link to="/dashboard" className="Submit__revise-link">
          Revise Service Spending
        </Link>
