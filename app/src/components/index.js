              ...
              <div className="row">
                <Switch className="row">
                  ...
                  <Route
                    ...
                    isAuthed={authed}
                    render={() => {
                      return authed ? <Redirect to="/intro/1" /> : <Home />;
                    }}
                  />
                  <Route
                    path="/intro/:id"
                  ...
                  <Route
                    path="/dashboard"
                    render={props => (
                      <DashboardContainer {...props} user={user} />
                    )}
                  />
                  <Route
                    path="/service/:id"
                  ...
                  />
                  <Route
                    path="/service/:service_id/department/:id"
                    exact
                    render={props => (
                      <DepartmentContainer {...props} user={user} />
                    )}
                  />
                  <Route
                    path="/service/:service_id/department/:id/learn-more"
                    render={props => <LearnMore {...props} />}
                  />
                  <Route
                    path="/service/:service_id/department/:id/explain"
                  ...
                  <Route
                    render={() => (
                      <h3>404, you ain&apos;t supposed to be here</h3>
                    )}
                  />
                </Switch>
              </div>
