...
const introText = [
  ...
  'This money comes from the General Fund for 2018-19. Only money from the General Fund can be spent; the remaining City of Savannah funds comprise what is called the "Special Revenue Fund,"" which is comprised of money that is made from services fees and other revenue streams.',
...
const introImages = [
  ...
  {
    src: introImg2,
    alt: 'two anonymous civil servants',
    confetti: introConfetti2,
  },
  ...
  return (
    <div className="intro">
      ...
      <div className="intro__image-wrapper">
        ...
        <img
          src={image.src}
          className={`intro__img-${imageIndex}`}
          alt={image.alt}
        />
      </div>
