    ...
    return (
      <div id="landing">
        <section className="section">
          <h1>Savannah Budget Party</h1>
          <h3>Understand & Augment a City Budget for Savannah</h3>
          <p>
          ...
          <p>
            Commuting, construction, parks, public safety—every day you are
            impacted by city budget decisions.
          </p>
        </section>
        <section className="section section-secondary">
          ...
          <p>
            <Link to="/login" className="btn btn-secondary btn-cta">
              Start Budgeting
            </Link>
          </p>
        </section>
        <section className="section">
          <h1>It's A Party!</h1>
          <p>
            We want to work with our neighbors to create an open source platform
            for citizen inclusion
          </p>
          <p>
            Our team currently includes developers, designers, a publisher, a
            curriculum writer and educators
          </p>
          <p>
            <Link to="/login" className="btn btn-cta">
              Start Budgeting
        ...
        <section className="section section-tertiary">
          <h1>Support & More</h1>
          <h3>
            A few of the awesome organizations that have funded and supported
            budget party.
          </h3>
          ...
          <ul className="link-list">
            <li>
              <Link to="/login">Start Budgeting</Link>
            </li>
            <li>
...
Landing.defaultProps = {
  contributorsURL:
    'https://api.github.com/repos/open-austin/budgetparty/contributors',
};
