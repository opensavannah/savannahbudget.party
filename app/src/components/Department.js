...
const Department = props => {
  ...
  const nextLink =
    departmentIndex < serviceDepartments.length
    ...
    <div>
      ...
      <div className="Department">
        ...
        <div className="Department__body">
          ...
          <Link
            to={`/service/${service_id}/department/${id}/learn-more`}
          ...
          <Link
            to={`/service/${service_id}/department/${id}/explain`}
            className="Department__link"
          >
            <img src={comment} alt="Comment bubble icon" /> Explain your
            spending
          </Link>
          ...
          <div className="Department__review-buttons">
            <Link
              to={
                departmentIndex > 1
                  ? `/service/${service.index}/department/${id - 1}`
                  : `/service/${service.index}`
              }
            ...
            >
              <div className="flexconatiner">
                ...
                />
                <span className="right" style={{paddingRight: '20px'}}>
                  Prev
                </span>
              </div>
            </Link>
            ...
            >
              <span className="left" style={{paddingLeft: '20px'}}>
                Next
              </span>
              <img
                src={forwardArrow}
