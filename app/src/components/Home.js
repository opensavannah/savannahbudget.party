...
export default class Home extends Component {
  ...
  getAuthForm = () => {
    return this.state.activeTab === 0 ? (
      <AuthForm
        actionHandler={this.handleRegister}
  ...
  tabList = [{id: 0, text: 'Sign Up'}, {id: 1, text: 'Log in'}];
